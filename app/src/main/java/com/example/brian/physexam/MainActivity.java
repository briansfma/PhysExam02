package com.example.brian.physexam;
...
public class MainActivity extends ActionBarActivity {
    ...
    private ArrayList<ArrayList<String>> physExamQs = new ArrayList<ArrayList<String>>();

    private ArrayList<String> examHisNote = new ArrayList<String>();
    ...
    private void askItems(final ArrayList<ArrayList<String>> currentLoc,
        ...
        if (ci.size() > 6) {        // Anything passed in should be greater than 6 elements long
            AlertDialog.Builder itemAlert = new AlertDialog.Builder(MainActivity.this);
            ...
            if (!ci.get(5).isEmpty()) {         // 6th element is where the job aid is kept, if any
                FrameLayout imageLay = new FrameLayout(MainActivity.this);
